...
class Physics {
  ...
  processCollisions() {
	...
	continue;
      ...
      // console.log(breakable0, breakable1, collided0, collided1);
	...
	if ( contactPoint.getDistance() < 0.1 ) {
	  ...
	  userData1.collided = true;
        ...
        if ((userData0 && userData0.isTarget) || (userData1 && userData1.isTarget)) {
          ...
          // const target = userData0.isTarget ? rb0 : rb1;
  ...
  stopBodyAfterImpact(body) {
    // console.log('stopBodyAfterImpact', body);
